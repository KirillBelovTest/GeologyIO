...
$GeologyIODirectory::usage = "GeologyIO installation directory"
...
SEGYRead::usage = 
"SEGYRead[\"file.segy\", part], 
SEGYRead[\"file.segy\", part, options]"
...
toSEGYTraceHeader[target: "MVM" | "C"] := toSEGYTraceHeader[target] = 
	With[{$SEGYTraceHeaderSpecification = Values[$SEGYTraceHeaderSpecification]}, 
		Compile[{
			{values, _Integer, 1}
		}, 
			Module[{
...
SetAttributes[Names["`*"], ReadProtected]
